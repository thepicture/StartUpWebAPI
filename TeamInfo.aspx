...
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Panel  runat="server">
        ...
        <div class="div-size body-content section blacked wf-section body-background">
            ...
            <p style="margin-left:10px;" class="lead">
                <asp:Label runat="server" ID="CommentsCount"></asp:Label>
                    ...
                    <asp:TextBox TextMode="SingleLine"  
                        ...
                        Style=" margin-bottom:20px; border-style:inset; 
                        height: 70px; margin-left:10px; max-width:1300px; 
                        width:1030px !important; margin-right:6px;" 
