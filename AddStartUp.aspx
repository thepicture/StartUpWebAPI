...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="BindingStartupsContent">
    ...
    <asp:FileUpload runat="server" Style="margin-bottom:0px !important; font-size:17px; margin-left:70px; margin-right:20px; "  AllowMultiple="true" ID="FileUploadImages" />
