...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="BindingStartupsContent">
    ...
    <asp:TextBox AutoPostBack="true" runat="server" ID="TBoxName" Width="200" TextMode="SingleLine"></asp:TextBox>
    <br />
    ...
    <asp:TextBox AutoPostBack="true" runat="server" ID="TBoxMaxMembers" Width="50" TextMode="Number"></asp:TextBox>
    <br />
    <asp:Label runat="server" Text="Описание"></asp:Label>
    <asp:TextBox AutoPostBack="true" runat="server" ID="TBoxDescription" Width="200" Height="80"></asp:TextBox>
    <br />
