...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <h2 align="center" class="titlePagesMargin"><%: Title %></h2>
    <p class="text-danger">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="FullNameBox" CssClass="form-control textblock-design" TextMode="SingleLine" />
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="ConfirmPasswordBox" TextMode="Password" CssClass="form-control textblock-design" />
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="CreateUser_Click" type="button" Text="Зарегистрироваться" CssClass="btn btn-primary" />
            </div>
        </div>
