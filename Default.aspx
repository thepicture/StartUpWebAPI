<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="StartUpWebAPI.Default" %>
    ...
    <asp:LoginView runat="server">
        <AnonymousTemplate>
            <div class="jumbotron white-shadow-block radius-like" style="background:#FCFCFC; height: max-content;">
                ...
                <object type="image/svg+xml" class="bg-image-logo" style=" float:right; width:150px; height:150px; margin-top:-20px;"  data="Resources/LogoStarssss.svg">
